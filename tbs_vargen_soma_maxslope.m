...
%==========================================================================
% Raw data during induction are bandpass filtered (see preprocessing).  The
% maximum negative slope of the somatic recording (excluding stimulating
% artifact) is used as a proxy for somatic spiking activity. 
%==========================================================================
